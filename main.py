...
def start(_,message):
    ...
    message.reply_text(text =f""" *Welcome To Anime Publish Bot* Hello dear,/n/n Tell your request, query and other prblm related to channel. You tell directly to channel admins to resolve problem./n/n Use = `/request <query>` """ , reply_markup=InlineKeyboardMarkup(keyboard))
